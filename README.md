...
# First class
+ My teaching style: Teaching how vs teaching what
+ Get a feel for it: Hug and move together
+ Connecting through the embrace: How to move together
+ Starting with the same weight
...
# Combinations
+ Explanation: "You have to come up with your own sequence"
+ Refresh rebote
...
* Details:
  - Feet close
  - Weight between balls and toes
  - Loose knees
  - Vertical skewer
  - Stretch abs
  - Shoulders and elbows fall down
...
+ Follower names aloud the instrument the leader is using (track: Ahora no me conosces)
+ Dance with the hand

## Mindset
+ Don't rush to show off: when we feel that need, it's a signal that are doing something wrong
